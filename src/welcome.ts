...
export class Welcome extends TwinkleModule {
	...
	static callback(uid) {
		...
		Window.setTitle('Dar boas vindas ao utilizador');
	...
	static templates = {
		standard: {
			'Predefinições de boas-vindas': {
				'Bem-vindo(a)/Registrado': {
					description: 'Mensagem de boas vindas para usuários registrados',
					linkedArticle: true,
					syntax: '{{subst:Bem-vindo(a)/Registrado}} ~~~~',
				},
				'welcome-retro': {
	...
	static callbacks = {
		...
		main: function (pageobj) {
			...
			var summaryText = 'Bem-vindo(a) à Wikipédia!';
